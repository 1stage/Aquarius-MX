...
## Status Updates
- **21 JAN 2023** - Published version 1-4-0c of the PCB. Allows use of either Type A or Type B CH376S USB interface boards, and allows use of less expensive metal DB9 connectors.
