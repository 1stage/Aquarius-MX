...
## Status Updates
- **11 APR 2023** - Dev team working on v1.3 of the MX ROM, focusing on integrating a Dallas DS1244 RTC (Real Time Clock) that can be used in place of the 32k RAM chip
